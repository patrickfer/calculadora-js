<h1>Calculadora Simples com HTML, CSS e JAVASCRIPT<br> <h2>Neste projeto desenvolvi uma calculadora simples para testar meus conhecimentos em HTML, CSS e Javascript.</h2></h1>
